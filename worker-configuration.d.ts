/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: d1be3abe2013def3007cb13d71a6d441)
// Runtime types generated with workerd@1.20250927.0 2025-09-16 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		CLOUDFLARE_STREAM_IMAGES_ANALYTICS_TOKEN: string;
		DATABASE_ID: string;
		CLOUDFLARE_DATABASE_ID: string;
		JWT_SECRET: string;
		SESSION_SECRET: string;
		ROOT_URL: string;
		STAGING_DATABASE_ID: string;
		STAGING_DATABASE_NAME: string;
		STAGING_WORKER_NAME: string;
		STAGING_JWT_SECRET: string;
		STAGING_SESSION_SECRET: string;
		PRODUCTION_DATABASE_ID: string;
		PRODUCTION_DATABASE_NAME: string;
		PRODUCTION_WORKER_NAME: string;
		PRODUCTION_JWT_SECRET: string;
		PRODUCTION_SESSION_SECRET: string;
		GTAG: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_ACCOUNT_EMAIL" | "CLOUDFLARE_STREAM_IMAGES_ANALYTICS_TOKEN" | "DATABASE_ID" | "CLOUDFLARE_DATABASE_ID" | "JWT_SECRET" | "SESSION_SECRET" | "ROOT_URL" | "STAGING_DATABASE_ID" | "STAGING_DATABASE_NAME" | "STAGING_WORKER_NAME" | "STAGING_JWT_SECRET" | "STAGING_SESSION_SECRET" | "PRODUCTION_DATABASE_ID" | "PRODUCTION_DATABASE_NAME" | "PRODUCTION_WORKER_NAME" | "PRODUCTION_JWT_SECRET" | "PRODUCTION_SESSION_SECRET" | "GTAG" | "GOOGLE_OAUTH_CLIENT_ID">> {}
}
